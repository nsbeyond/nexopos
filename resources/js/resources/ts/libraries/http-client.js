...
export class HttpClient {
    ...
    _request(type, url, data = {}, config = {}) {
        ...
        return new rxjs.Observable(observer => {
            this._client[type](url, data, Object.assign(Object.assign({}, this._client.defaults[type]), config)).then(result => {
                ...
                var _a;
                observer.error(((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.response || error);
                this._subject.next({ identifier: 'async.stop' });
            });
        });
    }
