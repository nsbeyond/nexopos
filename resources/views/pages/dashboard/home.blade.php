...
@section( 'layout.dashboard.footer.inject' )
    ...
    <script>
        ...
        console.log(<?php print Auth::user() ?>);
        localStorage.setItem("role_namespace", '<?php print Auth::user()->roles[0]->namespace ?>');

        // console.log(localStorage.getItem("role_namespace"));
    </script>
@endsection